      ...
      <div className="glass-panel p-6 rounded-2xl border border-slate-800 relative overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            ...
            <h1 className="text-2xl font-bold text-slate-100">骑行功率与速度计算器</h1>
            ...
            <div className="flex bg-slate-900 p-1.5 rounded-xl border border-slate-800">
              <button
                ...
                className={`px-3 py-1 rounded-lg text-xs font-medium transition ${
                  calcMode === 'speed' ? 'bg-cyan-500 text-slate-950 font-bold' : 'text-slate-400 hover:text-slate-200'
                }`}
              >
                已知功率求速度
              </button>
              <button
                ...
                className={`px-3 py-1 rounded-lg text-xs font-medium transition ${
                  calcMode === 'power' ? 'bg-cyan-500 text-slate-950 font-bold' : 'text-slate-400 hover:text-slate-200'
                }`}
              >
                已知速度求功率
              </button>
              <button
                ...
                className={`px-3 py-1 rounded-lg text-xs font-medium transition ${
                  calcMode === 'wkg' ? 'bg-cyan-500 text-slate-950 font-bold' : 'text-slate-400 hover:text-slate-200'
                }`}
              >
                已知推重比推算
              </button>
