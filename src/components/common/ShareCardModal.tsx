      ...
      <div className="relative w-full max-w-lg max-h-[92vh] flex flex-col bg-[#1C1C1E] border border-white/10 rounded-3xl shadow-2xl overflow-hidden text-white isolate">
        ...
        <div className="relative z-10 flex items-center justify-between px-5 py-4 border-b border-white/10 bg-[#1C1C1E]/90 backdrop-blur-md">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[11px] text-slate-400">朋友圈 / 社群打卡高光海报</p>
            </div>
          </div>
          <button
            type="button"
            onClick={onClose}
            className="w-8 h-8 rounded-full bg-white/10 hover:bg-white/20 text-slate-300 hover:text-white flex items-center justify-center transition apple-touch"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="relative z-10 p-4 border-t border-white/10 bg-[#1C1C1E]/95 flex flex-wrap items-center justify-between gap-2.5">
          <button
            ...
            className="apple-touch flex-1 sm:flex-initial flex items-center justify-center gap-1.5 px-4 py-2.5 rounded-xl bg-white/10 hover:bg-white/15 text-slate-200 text-xs font-semibold border border-white/10 transition active:scale-95"
          >
            {hasCopied ? (
              <>
